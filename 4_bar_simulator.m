...
if type_of_mechanism == 1
    ...
    need = input("input 1 if you need at a certain instant, 2 for full animation or 3 for graphs: " );
    if need == 1
...
if type_of_mechanism == 2
 ...
 % r0 is the offset
    ...
    choosing_instant_animation_or_graphs = input("For kinematic analysis of crank slider at a certain instant, press 1, For animation of crank slider press 2, for graphs press 3: ");
...
% Animation for crank slider + graphs for change in theta2 and theta3 w.r.t time: 
    ...
    if choosing_instant_animation_or_graphs == 3
